...
export default [
  {
    ...
    register: 'casual',
    prereqs: [
      { id: 'fc_01', japanese: 'よう', english: 'hey', type: 'greeting' },
      { id: 'fc_02', japanese: 'ひさしぶり', english: 'long time no see', type: 'greeting' },
      { id: 'fc_03', japanese: 'げんき？', english: 'how are you?', type: 'check-in' },
      { id: 'fc_04', japanese: 'まあまあ', english: 'so-so', type: 'response' },
      { id: 'fc_05', japanese: 'げんき', english: "I'm good", type: 'response' },
      { id: 'fc_06', japanese: 'いそがしい', english: 'busy', type: 'response' },
      { id: 'fc_07', japanese: 'まじで？', english: 'really?', type: 'reaction' },
      { id: 'fc_08', japanese: 'すごい', english: 'amazing', type: 'reaction' },
      { id: 'fc_09', japanese: 'いいね', english: 'nice', type: 'reaction' },
      { id: 'fc_10', japanese: 'たいへんだね', english: "that's tough", type: 'reaction' },
      { id: 'fc_11', japanese: 'また こんど あそぼう', english: "let's hang out sometime", type: 'suggestion' },
      { id: 'fc_12', japanese: 'ひま な とき れんらく して', english: 'hit me up when you have time', type: 'suggestion' },
      { id: 'fc_13', japanese: 'じゃあね', english: 'see ya', type: 'farewell' },
      { id: 'fc_14', japanese: 'またね', english: 'see you later', type: 'farewell' },
      { id: 'fc_15', japanese: 'おつかれ', english: 'good work / take it easy', type: 'farewell' },
      { id: 'fc_16', japanese: 'がんばって', english: 'good luck / do your best', type: 'farewell' },
    ],
    exchanges: [
      // ── Exchange 1: Greeting ──────────────────────────
      {
